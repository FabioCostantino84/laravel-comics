...
<head>
    ...
    <!-- Styles -->
    @vite('resources/js/app.js') {{-- Assicurati che questa riga sia corretta se stai utilizzando Vite --}}
...
<body>
    ...
    <header>
        ...
        <div class="container-fluid">
            {{-- Includi la navbar dal file parziale --}}
            @include('partials.navbar')

            {{-- Includi il jumbotron dal file parziale --}}
